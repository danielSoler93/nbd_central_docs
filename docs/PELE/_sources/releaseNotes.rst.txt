...
*******************************
- New algorithm is performed when doing a Ligand Perturbation, if the Ligand has a large number of rotable bonds. The rotable bonds now will be **randomly selected** following a freedom criteria.
...
- Some errors now are printed properly trhough cerr and not cout.
